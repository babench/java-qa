...
@Log4j2
public class MobilePhonePageTest extends DriverBase {
    ...
    public void shouldOpen() {
        openMobilePhonePage();
        assertThat(mobilePhonePagePO.getHeaderText()).isEqualTo("Мобильные телефоны");
    }
    ...
    @Test
    public void shouldCompareTopProductsOfProducer() throws InterruptedException {
        openMobilePhonePage();
        assertThat(mobilePhonePagePO.getHeaderText()).isEqualTo("Мобильные телефоны");
    ...
    @Test
    public void shouldCompareCheapestBetweenProducers() throws InterruptedException {
        openMobilePhonePage();
        assertThat(mobilePhonePagePO.getHeaderText()).isEqualTo("Мобильные телефоны");
